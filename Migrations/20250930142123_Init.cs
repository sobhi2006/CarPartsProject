        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusPart = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CountryPartId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Parts_Brands_CarPartBrandId",
                        column: x => x.CarPartBrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Parts_Countries_CountryPartId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_Parts_CarPartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_CarPartId",
                table: "Images",
                column: "CarPartId");

            migrationBuilder.CreateIndex(
                name: "IX_Parts_CarPartBrandId",
                table: "Parts",
                column: "CarPartBrandId");

            migrationBuilder.CreateIndex(
                name: "IX_Parts_CountryPartId",
                table: "Parts",
